    ...
    <div class=p-10">
        <ul class="submenu-title">
            <c:forEach items="${subMenuList}" var="item">
                <c:set var="className" value="${item.href == lastPath ? 'menu-selected' : ''}" />
                <li class="p-ud5-lr10 ${className}"><a href="/user/mypage/${item.href}" class="font-solid font-color-black">${item.nm}</a></li>
            </c:forEach>
        </ul>
    </div>
    <div class="p-10">
